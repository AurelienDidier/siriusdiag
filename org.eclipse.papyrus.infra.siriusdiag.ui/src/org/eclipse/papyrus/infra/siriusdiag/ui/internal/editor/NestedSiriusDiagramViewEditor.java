 ...
 */
public class NestedSiriusDiagramViewEditor extends SiriusDiagramEditor implements IEditingDomainProvider, IInternationalizationEditor, IRevealSemanticElement, NavigationTarget, DDiagramEditor, ISelectionListener, SessionListener {
	/**
	...
	private static final class SessionHandlingForEditor extends SessionManagerListener.Stub {
		private NestedSiriusDiagramViewEditor editor;

		SessionHandlingForEditor(NestedSiriusDiagramViewEditor editor) {
			this.editor = editor;
		}
