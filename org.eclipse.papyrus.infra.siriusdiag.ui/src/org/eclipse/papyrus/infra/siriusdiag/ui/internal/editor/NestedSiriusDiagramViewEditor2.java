 ...
 */
public class NestedSiriusDiagramViewEditor2 extends SiriusDiagramEditor implements IEditingDomainProvider, IInternationalizationEditor, IRevealSemanticElement, NavigationTarget, DDiagramEditor, ISelectionListener, SessionListener {
	/**
	...
	private static final class SessionHandlingForEditor extends SessionManagerListener.Stub {
		private NestedSiriusDiagramViewEditor2 editor;

		SessionHandlingForEditor(NestedSiriusDiagramViewEditor2 editor) {
			this.editor = editor;
		}
	...
	protected class DDiagramEditorTransferDropTargetListener extends AbstractTransferDropTargetListener {
		...
		protected Request createTargetRequest() {
			...
			final List<EditPart> list = new ArrayList<>(1);
	 ...
	 */
	public NestedSiriusDiagramViewEditor2() {
		super();
	 ...
	 */
	public NestedSiriusDiagramViewEditor2(IOperationHistoryListener operationHistoryListener) {
		super();
				...
				try {
					if (getGraphicalViewer() != null && !PlatformUI.getWorkbench().isClosing()) {
						...
						if (site != null) {
							...
							if (page != null) {
								page.closeEditor(NestedSiriusDiagramViewEditor2.this, save);
							}
						}
					}
	...
	public void selectionChanged(final IWorkbenchPart part, final ISelection selection) {
		...
		if (isDiagramOutlinePage(part) && selection instanceof IStructuredSelection) {
			...
			final List<IGraphicalEditPart> result = new ArrayList<>(selected.size());
	...
	public SiriusInformationPresenter getQuickOutlinePresenter() {
		SiriusInformationPresenter informationPresenter = new SiriusInformationPresenter(new IInformationControlCreator() {
			...
			public IInformationControl createInformationControl(Shell parent) {
				return new QuickOutlineControl(parent, SWT.RESIZE, NestedSiriusDiagramViewEditor2.this);
			}
		});
	...
	/**
	 * @see org.eclipse.papyrus.infra.widgets.util.NavigationTarget#revealElement(java.lang.Object)
	 *
	 * @param element
	 * @return
	 */
